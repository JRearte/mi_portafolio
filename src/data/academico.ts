import { FaBrain, FaProjectDiagram, FaCodeBranch, FaUserCheck, FaRegHandshake } from "react-icons/fa";
...
export const sumarios = [
  ...
  },
  {
    ...
    items: [
      ...
      { texto: "Trabajo cooperativo", icono: FaRegHandshake, title: "Colaboración efectiva en equipos multidisciplinarios" },
      { texto: "Trabajo en equipo", icono: FaRegHandshake, title: "Participación activa en entornos colaborativos, con enfoque en objetivos comunes" },
